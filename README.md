...
The useRouteMatch hook lets you nest routes to your app so you can change a single parameter in the URL without having to change the entire address. For example in an URL like this one: site.com/work/id1/work-details, you can just change the id's.

1. How would you explain form validation to someone who has never programmed before?

Form validation is a way to make sure that whoever is using your website they type in the correct information. For example if your form has name input, you wouldn't want to have numbers or a name with only one character, so you can add things like, name input must have at least 3 characters etc.
